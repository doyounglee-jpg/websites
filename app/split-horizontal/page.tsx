...
/**
 * Split homepage variant — horizontal top/bottom split.
 *
 * Layout: Clerkie occupies the top half (dark bg, content aligned left).
 * Fiber occupies the bottom half (light bg, content aligned right).
 * Each half is a single Link to its product page. No diagonal,
 * no device mockups, no hover pills — the simplified version.
 *
 * Source: Figma file wX2OdcKMUlEwnFjV0idi11 (Frame 1618872612).
 */
export default function SplitHorizontalPage() {
  return (
