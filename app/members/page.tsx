 ...
 *   9. Footer
 *
 * Color palette (Amber-coral on true-neutral dark):
 *   - Ground:        #111112  → bg-[#111112]
 *   - Accent:        #F0784E  → bg-[#F0784E] / text-[#F0784E]
...
export default function MembersPage() {
  return (
    <main className="min-h-screen bg-[#111112] text-zinc-50">
      {/* ============================================================
          1. NAV — hairline border, blurred dark background
         ============================================================ */}
      <header className="sticky top-0 z-50 w-full border-b border-white/[0.06] bg-[#111112]/60 backdrop-blur-md">
        <nav className="mx-auto flex w-full max-w-[1440px] items-center justify-between px-6 py-4 sm:px-10 sm:py-5 md:px-16">
          ...
          <div className="hidden md:flex">
            <a
              href="#cta"
              className="rounded-lg bg-zinc-50 px-3.5 py-2 text-[13px] font-medium tracking-[-0.005em] text-[#111112]"
            >
              Get the App
            </a>
          </div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex max-w-[1440px] flex-col items-center gap-8 px-6 pb-12 pt-20 sm:gap-10 sm:px-10 sm:pb-16 sm:pt-28 md:px-16 md:pb-20 md:pt-[120px]">
          ...
          <div className="flex items-center gap-3">
            <a
              href="#cta"
              className="flex items-center gap-2 rounded-[10px] bg-zinc-50 px-5 py-3 text-sm font-medium tracking-[-0.005em] text-[#111112]"
            >
              Get the App
      ...
      <section className="border-t border-white/[0.06]">
        <div className="mx-auto max-w-[1440px] px-6 pb-20 pt-24 sm:px-10 sm:pb-24 sm:pt-28 md:px-16 md:pb-28 md:pt-32 lg:px-24 lg:pb-32 lg:pt-40">
          ...
          <div className="overflow-x-auto rounded-2xl border border-white/[0.06] bg-white/[0.02]">
            ...
            {/* Footer (totals) */}
            <div className="flex items-center border-t border-white/[0.06] bg-[#F0784E]/[0.04] px-6 py-4">
              <div className="flex w-14 shrink-0 items-center">
                <span
                  className="block h-2 w-2 rounded-full bg-[#F0784E]"
                  style={{ boxShadow: "0 0 12px rgba(240,120,78,0.6)" }}
                />
              </div>
              ...
              <span className="w-40 shrink-0 text-right font-mono text-base font-semibold tracking-[-0.01em] text-[#F0784E]">
                $78,649,338
              </span>
            </div>
            </div>
      ...
      {/* ============================================================
          9. FOOTER
         ============================================================ */}
      <footer className="border-t border-white/[0.08] bg-[#111112]/60">
        <div className="mx-auto flex max-w-[1440px] flex-col gap-12 px-6 pb-12 pt-12 sm:px-10 sm:pt-16 md:px-16 lg:px-24">
          ...
          <div className="flex flex-col items-start justify-between gap-4 border-t border-white/[0.06] pt-6 sm:flex-row sm:items-center sm:gap-0 sm:pt-8">
            ...
            <div className="flex items-center gap-2">
              <span
                className="block h-1.5 w-1.5 rounded-full bg-[#F0784E]"
                style={{ boxShadow: "0 0 10px rgba(240,120,78,0.7)" }}
              />
...
function SectionEyebrow({ children }: { children: React.ReactNode }) {
  return (
    <span className="text-[13px] font-medium tracking-[0.06em] text-[#F0784E]">
      {children}
    </span>
  );
}
  ...
  return (
    ...
    >
      ...
      <div className="flex w-40 shrink-0 items-center justify-end gap-2">
        <span className="font-mono text-[15px] font-medium text-[#F0784E]">{saved}</span>
        <span className="rounded-md bg-[#F0784E]/10 px-1.5 py-0.5 text-[11px] font-medium tracking-[0.02em] text-[#F0784E]">
          {pct}
        </span>
      </div>
    </div>
    ...
    <div className="flex flex-1 flex-col overflow-hidden rounded-[18px] border border-white/10 bg-[#101113]/60 backdrop-blur">
      ...
      <div className="flex items-center justify-between border-b border-white/[0.06] px-4.5 py-3.5">
        <div className="flex items-center gap-2">
          ...
          <span className="flex items-center gap-1.5 rounded-full bg-[#F0784E]/10 px-2 py-0.5">
            <span className="block h-[5px] w-[5px] rounded-full bg-[#F0784E]" />
            <span className="text-[10px] font-medium tracking-[0.04em] text-[#F0784E]">
              ONLINE
            </span>
          </span>
        </div>
      ...
      <div className="flex flex-col gap-4 px-6 py-6">
        ...
        <div className="flex flex-col items-start gap-2.5 pr-15">
          ...
          {/* Reasoning card */}
          <div className="flex w-full flex-col gap-2.5 rounded-xl border border-white/10 bg-[#111112]/60 px-4 py-3.5">
      ...
      {/* Input row */}
      <div className="flex items-center gap-2.5 border-t border-white/[0.06] bg-[#111112]/40 px-4.5 py-3.5">
        <span className="flex-1 text-sm tracking-[-0.005em] text-zinc-600">
          Ask anything about your money…
        </span>
        <div className="flex items-center gap-2">
          <span className="font-mono text-[11px] text-zinc-600">↵</span>
          <button className="flex h-7 w-7 items-center justify-center rounded-lg bg-zinc-50 text-sm font-semibold text-[#111112]">
            ↑
          </button>
        </div>
      </div>
    ...
    <div className="flex min-h-[240px] basis-full flex-col gap-6 bg-[#0C0D0F] px-6 py-7 sm:basis-[calc(50%-1px)] sm:px-8 sm:py-9 lg:basis-[calc(33.333%-1px)]">
      <div className="flex h-11 w-11 items-center justify-center rounded-xl border border-white/10 bg-white/5">
        <div className="relative h-4 w-5.5 rounded-[3px] bg-white/40">
          <div className="absolute left-0 top-1 h-[3px] w-full bg-[#111112]/40" />
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 pt-1">
        ...
        <span className="font-mono text-[13px] font-medium text-[#F0784E]">{statValue}</span>
      </div>
    </div>
  );
}
...
function SafetyStatBlock({
  ...
  return (
    <div className="relative z-10 flex flex-1 flex-col gap-4.5 rounded-[18px] border border-white/10 bg-[#101113]/60 p-8 backdrop-blur">
      <span className="text-xs font-medium tracking-[0.04em] text-[#F0784E]">
        {label}
      </span>
      <span className="text-[56px] font-semibold leading-none tracking-[-0.04em] text-[#F0784E]">
        {value}
      </span>
      {children}
    </div>
  ...
  return (
    <div className="flex flex-col gap-2.5 rounded-[14px] border border-white/10 bg-white/[0.04] p-4.5">
      ...
      <div className="flex gap-2 pt-1">
        <span className="rounded-lg bg-zinc-50 px-3 py-1.5 text-xs font-medium text-[#111112]">
          Yes, cover it
        </span>
...
function AppStoreButton({ variant }: { variant: "apple" | "google" }) {
  if (variant === "apple") {
    return (
      <div className="flex items-center gap-3 rounded-xl bg-zinc-50 px-5.5 py-3.5">
        <div className="flex h-6 w-6 items-center justify-center rounded-md bg-[#111112]" />
        <div className="flex flex-col">
          <span className="text-[11px] font-normal tracking-[0.02em] text-[#111112]/60">
            Download on the
          </span>
          <span className="text-base font-semibold tracking-[-0.01em] text-[#111112]">
            App Store
          </span>
        </div>
      </div>
  ...
  return (
    <div className="flex items-center gap-3 rounded-xl border border-white/10 bg-white/[0.06] px-5.5 py-3.5">
      <div className="flex h-6 w-6 items-center justify-center rounded-md bg-zinc-50 text-sm font-semibold text-[#111112]">
        ▶
      </div>
      <div className="flex flex-col">
