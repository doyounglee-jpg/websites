 ...
 *   9. Footer
 *
 * Color palette (Terracotta on true-neutral dark):
 *   - Ground:        #111112  → bg-[#111112]
 *   - Accent:        #D4593E  → bg-[#D4593E] / text-[#D4593E]
      ...
      <section className="border-t border-white/[0.06]">
        <div className="mx-auto max-w-[1440px] px-6 pb-20 pt-24 sm:px-10 sm:pb-24 sm:pt-28 md:px-16 md:pb-28 md:pt-32 lg:px-24 lg:pb-32 lg:pt-40">
          ...
          <div className="overflow-x-auto rounded-2xl border border-white/[0.06] bg-white/[0.02]">
            ...
            {/* Footer (totals) */}
            <div className="flex items-center border-t border-white/[0.06] bg-[#D4593E]/[0.04] px-6 py-4">
              <div className="flex w-14 shrink-0 items-center">
                <span
                  className="block h-2 w-2 rounded-full bg-[#D4593E]"
                  style={{ boxShadow: "0 0 12px rgba(212,89,62,0.6)" }}
                />
              </div>
              ...
              <span className="w-40 shrink-0 text-right font-mono text-base font-semibold tracking-[-0.01em] text-[#D4593E]">
                $78,649,338
              </span>
            </div>
            </div>
        ...
        <div className="mx-auto flex max-w-[1440px] flex-col gap-12 px-6 pb-12 pt-12 sm:px-10 sm:pt-16 md:px-16 lg:px-24">
          ...
          <div className="flex flex-col items-start justify-between gap-4 border-t border-white/[0.06] pt-6 sm:flex-row sm:items-center sm:gap-0 sm:pt-8">
            ...
            <div className="flex items-center gap-2">
              <span
                className="block h-1.5 w-1.5 rounded-full bg-[#D4593E]"
                style={{ boxShadow: "0 0 10px rgba(212,89,62,0.7)" }}
              />
...
function SectionEyebrow({ children }: { children: React.ReactNode }) {
  return (
    <span className="text-[13px] font-medium tracking-[0.06em] text-[#D4593E]">
      {children}
    </span>
  );
}
  ...
  return (
    ...
    >
      ...
      <div className="flex w-40 shrink-0 items-center justify-end gap-2">
        <span className="font-mono text-[15px] font-medium text-[#D4593E]">{saved}</span>
        <span className="rounded-md bg-[#D4593E]/10 px-1.5 py-0.5 text-[11px] font-medium tracking-[0.02em] text-[#D4593E]">
          {pct}
        </span>
      </div>
    </div>
    ...
    <div className="flex flex-1 flex-col overflow-hidden rounded-[18px] border border-white/10 bg-[#101113]/60 backdrop-blur">
      ...
      <div className="flex items-center justify-between border-b border-white/[0.06] px-4.5 py-3.5">
        <div className="flex items-center gap-2">
          ...
          <span className="flex items-center gap-1.5 rounded-full bg-[#D4593E]/10 px-2 py-0.5">
            <span className="block h-[5px] w-[5px] rounded-full bg-[#D4593E]" />
            <span className="text-[10px] font-medium tracking-[0.04em] text-[#D4593E]">
              ONLINE
            </span>
          </span>
        </div>
  ...
  return (
    <div className="flex min-h-[240px] basis-full flex-col gap-6 bg-[#0C0D0F] px-6 py-7 sm:basis-[calc(50%-1px)] sm:px-8 sm:py-9 lg:basis-[calc(33.333%-1px)]">
      ...
      <div className="flex items-center gap-2 pt-1">
        ...
        <span className="font-mono text-[13px] font-medium text-[#D4593E]">{statValue}</span>
      </div>
    </div>
  );
}
...
function SafetyStatBlock({
  ...
  return (
    <div className="relative z-10 flex flex-1 flex-col gap-4.5 rounded-[18px] border border-white/10 bg-[#101113]/60 p-8 backdrop-blur">
      <span className="text-xs font-medium tracking-[0.04em] text-[#D4593E]">
        {label}
      </span>
      <span className="text-[56px] font-semibold leading-none tracking-[-0.04em] text-[#D4593E]">
        {value}
      </span>
      {children}
    </div>
