...
export default function MembersPage() {
  return (
    <main className="min-h-screen bg-[#0E0F11] text-zinc-50">
      {/* ============================================================
          1. NAV — hairline border, blurred dark background
         ============================================================ */}
      <header className="sticky top-0 z-50 w-full border-b border-white/[0.06] bg-[#0E0F11]/60 backdrop-blur-md">
        <nav className="mx-auto flex w-full max-w-[1440px] items-center justify-between px-6 py-4 sm:px-10 sm:py-5 md:px-16">
          ...
          <div className="hidden md:flex">
            <a
              href="#cta"
              className="rounded-lg bg-zinc-50 px-3.5 py-2 text-[13px] font-medium tracking-[-0.005em] text-[#0E0F11]"
            >
              Get the App
            </a>
          </div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex max-w-[1440px] flex-col items-center gap-8 px-6 pb-12 pt-20 sm:gap-10 sm:px-10 sm:pb-16 sm:pt-28 md:px-16 md:pb-20 md:pt-[120px]">
          ...
          <div className="flex items-center gap-3">
            <a
              href="#cta"
              className="flex items-center gap-2 rounded-[10px] bg-zinc-50 px-5 py-3 text-sm font-medium tracking-[-0.005em] text-[#0E0F11]"
            >
              Get the App
      ...
      {/* ============================================================
          9. FOOTER
         ============================================================ */}
      <footer className="border-t border-white/[0.08] bg-[#0E0F11]/60">
    ...
    <div className="flex flex-1 flex-col overflow-hidden rounded-[18px] border border-white/10 bg-[#101113]/60 backdrop-blur">
      ...
      <div className="flex flex-col gap-4 px-6 py-6">
        ...
        <div className="flex flex-col items-start gap-2.5 pr-15">
          ...
          {/* Reasoning card */}
          <div className="flex w-full flex-col gap-2.5 rounded-xl border border-white/10 bg-[#0E0F11]/60 px-4 py-3.5">
      ...
      {/* Input row */}
      <div className="flex items-center gap-2.5 border-t border-white/[0.06] bg-[#0E0F11]/40 px-4.5 py-3.5">
        <span className="flex-1 text-sm tracking-[-0.005em] text-zinc-600">
          Ask anything about your money…
        </span>
        <div className="flex items-center gap-2">
          <span className="font-mono text-[11px] text-zinc-600">↵</span>
          <button className="flex h-7 w-7 items-center justify-center rounded-lg bg-zinc-50 text-sm font-semibold text-[#0E0F11]">
            ↑
          </button>
        </div>
      </div>
    ...
    <div className="flex min-h-[240px] basis-full flex-col gap-6 bg-[#0C0D0F] px-6 py-7 sm:basis-[calc(50%-1px)] sm:px-8 sm:py-9 lg:basis-[calc(33.333%-1px)]">
      <div className="flex h-11 w-11 items-center justify-center rounded-xl border border-white/10 bg-white/5">
        <div className="relative h-4 w-5.5 rounded-[3px] bg-white/40">
          <div className="absolute left-0 top-1 h-[3px] w-full bg-[#0E0F11]/40" />
        </div>
      </div>
  ...
  return (
    <div className="flex flex-col gap-2.5 rounded-[14px] border border-white/10 bg-white/[0.04] p-4.5">
      ...
      <div className="flex gap-2 pt-1">
        <span className="rounded-lg bg-zinc-50 px-3 py-1.5 text-xs font-medium text-[#0E0F11]">
          Yes, cover it
        </span>
...
function AppStoreButton({ variant }: { variant: "apple" | "google" }) {
  if (variant === "apple") {
    return (
      <div className="flex items-center gap-3 rounded-xl bg-zinc-50 px-5.5 py-3.5">
        <div className="flex h-6 w-6 items-center justify-center rounded-md bg-[#0E0F11]" />
        <div className="flex flex-col">
          <span className="text-[11px] font-normal tracking-[0.02em] text-[#0E0F11]/60">
            Download on the
          </span>
          <span className="text-base font-semibold tracking-[-0.01em] text-[#0E0F11]">
            App Store
          </span>
        </div>
      </div>
  ...
  return (
    <div className="flex items-center gap-3 rounded-xl border border-white/10 bg-white/[0.06] px-5.5 py-3.5">
      <div className="flex h-6 w-6 items-center justify-center rounded-md bg-zinc-50 text-sm font-semibold text-[#0E0F11]">
        ▶
      </div>
      <div className="flex flex-col">
