...
/**
 * /companies-v7 — Origin-style visual language.
...
export default function CompaniesV7Page() {
  return (
    <main className="min-h-screen bg-[#0E1014] text-zinc-50">
      ...
      <header className="fixed left-1/2 top-5 z-50 -translate-x-1/2">
        <nav className="flex items-center gap-1 rounded-full border border-white/15 bg-black/30 px-2 py-1.5 backdrop-blur-md">
          ...
          <PillNavLink href="/companies-v7" active>Companies</PillNavLink>
      ...
      <footer className="border-t border-white/[0.08] bg-[#0E1014]">
        <div className="mx-auto flex max-w-[1440px] flex-col gap-12 px-10 py-16 md:px-16">
          <div className="flex flex-col items-start justify-between gap-10 md:flex-row md:items-end">
            ...
            <div className="grid w-full grid-cols-2 gap-10 sm:grid-cols-3 md:w-auto md:gap-20">
              <FooterCol title="PRODUCT" links={[
                ...
                { label: "For lenders" },
                { label: "For companies", href: "/companies-v7", active: true },
                { label: "Get the app" },
              ]} />
          ...
          <div className="flex items-center justify-between border-t border-white/[0.06] pt-6">
            <span className="font-mono text-xs text-zinc-600">© 2025 Henry Labs Inc. · /companies-v7 prototype</span>
